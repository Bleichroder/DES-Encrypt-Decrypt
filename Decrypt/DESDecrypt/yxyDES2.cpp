...
CString yxyDES2::DESr(CString strPlaintext, CString strKey)
{
	...
	CString a;
	a.Format(_T("%s"), hexCiphertextAnyLength);
	return a;
}
CString yxyDES2::DESw(CString strCiphertext,CString strKey)
{
	memset(szSourceKey1,0,8);
	memset(szSourceKey2,0,8);
	...
	CString a;
	a.Format(_T("%s"), GetPlaintextAnyLength());
	return a;
}
CString yxyDES2::DESr(CString strPlaintext, CString strKey,CString strKeyTDES)
{
	CString strCiphertext;
	memset(szSourceKey1,0,8);
	memset(szSourceKey2,0,8);
...
CString yxyDES2::DESw(CString strCiphertext,CString strKey,CString strKeyTDES)
{
	memset(szSourceKey1,0,8);
	memset(szSourceKey2,0,8);
	memset(szCiphertextData,0,8192);
...
void yxyDES2::ConvertCiphertext2OtherFormat(int iBitsLen,char *szCipherInBytes)
{
...
int yxyDES2::ConvertOtherFormat2Ciphertext(char *szCipher)
{
	int iLen = 0;
	memset(szCiphertextData,0,8192);
