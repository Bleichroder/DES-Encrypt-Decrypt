...
public:
		...
		//以下是重载函数
                //加密
		CString DESr(CString strPlaintext, CString strKey);
		//解密
		CString DESw(CString strCiphertext, CString strKey);
		//3DES 加密
		CString DESr(CString strPlaintext, CString strKey,CString strKeyTDES);
		//3DES 解密
		CString DESw(CString strCiphertext, CString strKey,CString strKeyTDES);
private:
